...
public class Settings : AManager<Settings>
{
    ...
    private void LoadGameData()
    {
        ...
        if (File.Exists(filePath))
        {
            ...
            if (LoadedData.NetworkType.Equals("Server"))
            {
                ...
                Player.DelayAvailable = LoadedData.DelayAvailable;
                Body.DestroyTime = LoadedData.DestroyTime;
            ...
            {
                /*
                // matrix for non stereoscopic displays
                ...
                */
                ...
                Camera.main.SetStereoProjectionMatrix(Camera.StereoscopicEye.Right, matRight);
    ...
    void PrintText()
    {
        ...
        if (LoadedData.NetworkType.Equals("Server"))
        {
            ...
            output.text += "\nDelay Available: " + LoadedData.DelayAvailable;
            output.text += "\nDestroyTime: " + LoadedData.DestroyTime;
