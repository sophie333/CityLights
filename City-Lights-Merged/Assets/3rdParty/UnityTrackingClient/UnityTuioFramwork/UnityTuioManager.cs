...
namespace UnityTuio
{
    ...
    public class UnityTuioManager : MonoBehaviour, ITrackingManager
    {
        ...
        public class TuioSettings
        {
            ...
            [Tooltip("in meters")]
            [SerializeField]
            private float _targetFloorWidth = 16;
            [Tooltip("in meters")]
            [SerializeField]
            private float _targetFloorHeight = 9;
            [Tooltip("in centimeter")]
            [SerializeField]
            private float _stageX = 1600f;
            [Tooltip("in centimeter")]
            [SerializeField]
            private float _stageY = 900f;
        ...
        private void UpdateDebugGUI()
        {
            ...
            {
                resolutionStatus.text = string.Format("Resolution: {0} x {1}", m_tuioSettings.TargetFloorWidth, m_tuioSettings.TargetFloorHeight);
            }
        }
        ...
        {
            get { return Instance.m_tuioSettings.TargetFloorWidth; }
        }
        public float TargetScreenHeight
        {
            get { return Instance.m_tuioSettings.TargetFloorHeight; }
        }
        ...
        //{
        //    return new Vector2((int)Mathf.Round(x * m_tuioSettings.TargetFloorWidth), m_tuioSettings.TargetFloorHeight - (int)Mathf.Round(y * m_tuioSettings.TargetFloorHeight));
        //}
        public Vector2 GetScreenPositionFromRelativePosition(float x, float y)
        {
            Vector2 newPos = new Vector2(x * m_tuioSettings.TargetFloorWidth - m_tuioSettings.TargetFloorWidth / 2,
                m_tuioSettings.TargetFloorHeight / 2 - y * m_tuioSettings.TargetFloorHeight);
            return newPos;
        }
        ...
        //{
        //    return new Vector2(tuioPoint.getScreenX(Instance.m_tuioSettings.TargetFloorWidth), Instance.m_tuioSettings.TargetFloorHeight - tuioPoint.getScreenY(Instance.m_tuioSettings.TargetFloorHeight));
        //}
        #endregion
    }
}